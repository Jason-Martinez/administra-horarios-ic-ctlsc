...
public class Main {
    ...
    // prof == null: muestra todo el semestre
    // =========================================================================
    ...
    static void imprimirTabla(Semestre sem, Profesor filtroProf) {
        ...
        System.out.printf(fmt, "#", "modelo.academico.Asignatura", "Tipo", "modelo.infraestructura.Aula", "modelo.usuarios.Profesor", "Dia", "Bloque");
        System.out.println(sep);
    ...
    static void mostrarUsuarios() {
        ...
        for (String[] c : credenciales) {
            ...
            if (u != null) {
                String rol = u instanceof Coordinador ? "modelo.usuarios.Coordinador"
                        : u instanceof Profesor    ? "modelo.usuarios.Profesor"
    ...
    static void cargarEscenarios() {
        ...
        aulasE1.add(new AulaTeoria("modelo.infraestructura.Aula T-101", 101, "Edificio A", 30, true, true));
        ...
        aulasE2.add(new AulaTeoria("modelo.infraestructura.Aula T-305", 305, "Edificio C", 35, false, true));
        aulasE2.add(new AulaTeoria("modelo.infraestructura.Aula T-306", 306, "Edificio C", 35, true,  false));
        ...
        aulasE3.add(new AulaTeoria("modelo.infraestructura.Aula T-501", 501, "Edificio E", 40, true, true));
        aulasE3.add(new AulaTeoria("modelo.infraestructura.Aula T-502", 502, "Edificio E", 40, true, true));
